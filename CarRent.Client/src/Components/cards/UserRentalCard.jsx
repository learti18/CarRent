        ...
        <div className="flex flex-col sm:flex-row h-full">
          ...
          <div className=" sm:w-2/5 md:w-1/3 relative h-full bg-gray-50 min-h-[200px]">
            ...
            <div className="absolute top-4 left-4 z-10 flex items-center gap-2">
              ...
              ></span>
              <span
                className={`px-2.5 py-1 rounded-full text-xs font-medium ${statusStyle.bg} ${statusStyle.text} shadow-sm`}
              >
                {status}
              </span>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-10 h-10 rounded-full ${statusStyle.icon} flex items-center justify-center shadow-sm`}
                  >
